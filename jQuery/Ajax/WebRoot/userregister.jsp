		...
		$(document).ready(function() {
			...
			$("#username").keyup(function(){
				...
				if(username.length<5)    //该用户名太短信息显示
				{
					...
					usermsg="<img src='images/false.jpg' width='25px' height='25px'>用户名太短！";
					$('#usermsg').html("用户名太短！");
				 	...
				 	$.ajax({ 
						...
						success: function(data) {
							if(data == "<img src='images/true.jpg' width='25px' height='25px'>")
							{
			...
			$("#password1").keyup(function(){
				...
				$('#msg_reg').html("");   //清空注册错误消息
			 	...
			 	}else
			 	{
			 		...
			 		$('#passmsg').html("<img src='images/true.jpg' width='25px' height='25px'>");
					passmsg1="";
			 	}
			});
					...
					var password=$('#password').val();
				 	$.ajax({ 
						...
						success: function(data) {
							...
							$('#content').append("<br>");
							$('#content').append("<a class='hreftype' href='index.jsp'>点击进入新闻系统首页</a>");
						} 
					});
				}else{
		...
		function getPasswordSecurity(pass){
			...
			else if(pattern.exec(pass))//如果密码是6个只包含数字，强度为中
			{
				...
				$('#flagStrong2').css({"background-color":"red"});
		 		...
		 		$('#passsecmsg').html("<img src='images/true.jpg' width='25px' height='25px'>");
				passmsg="";
			}
			else
			{
    	...
    	<div id="content" style="margin:30px 0 0 0;">
    	  <table width=100% style="font-size:1em;font-family:微软雅黑;">
    	    ...
    	    <tr>
    	      ...
    	      <div><a style="color:blue;" id="protocol" class="hreftype">《新闻系统协议》</a></div>
