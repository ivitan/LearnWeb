...
-- ----------------------------
-- Table structure for `buylisttable`
-- ----------------------------
...
-- ----------------------------
-- Records of buylisttable
-- ----------------------------
INSERT INTO `buylisttable` VALUES ('1', '28', '901', '901023', '冰糖心苹果', '19', '10', '80');
INSERT INTO `buylisttable` VALUES ('2', '0', '901', '901058', '皇帝蕉', '10', '11', '300');
INSERT INTO `buylisttable` VALUES ('3', '0', '901', '901044', '蜜桔', '8', '15', '500');
INSERT INTO `buylisttable` VALUES ('4', '0', '901', '901364', '大南果梨', '10', '20', '290');
INSERT INTO `buylisttable` VALUES ('9', '0', '903', '903023', '圆珠笔', '6', '100', '300');
INSERT INTO `buylisttable` VALUES ('12', '0', '903', '903364', '尺子', '2', '2', '100');
INSERT INTO `buylisttable` VALUES ('19', '0', '901', '903027', '东北山葡萄', '1', '20', '200');
...
CREATE TABLE `goods` (
  ...
  `goodsdetail` varchar(200) DEFAULT NULL,
  `goodsprice` double(255,0) DEFAULT NULL,
  `buynum` int(255) DEFAULT NULL,
  `storenum` int(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('2', '901', '901058', '皇帝蕉', 'img/banana.jpg', '皇帝蕉果长约10厘米左右，无籽，皮薄、熟后皮金黄色，果肉橙黄、清甜芬芳、香甜可口，营养丰富，富含多种维生素。', '10', '10', '300');
INSERT INTO `goods` VALUES ('3', '901', '901044', '蜜桔', 'img/orange.jpg', '南丰蜜桔为我国古老柑桔的优良品种之一，是江西省的名贵特产，以果色金黄、皮薄肉嫩、食不存渣、风味浓甜、芳香扑鼻而闻名中外。', '8', '10', '500');
INSERT INTO `goods` VALUES ('4', '901', '901364', '大南果梨', 'img/pear3.jpg', '大南果梨, 果面光滑，果皮黄色，阳面有红晕，果皮薄，果心小，可食率高，肉质细腻，易溶于口。果品质量极优，是馈赠亲友的上佳礼品。', '10', '10', '290');
INSERT INTO `goods` VALUES ('5', '902', '902078', '外套', 'img/coat.jpg', '本款男士外套面料为精纺呢绒，坚牢耐穿， 长时间内不变形， 显得庄重，质地滑爽，外观高雅、挺括、触感丰满、风格经典、光泽自 然柔和等特点。', '320', '10', '46');
INSERT INTO `goods` VALUES ('6', '902', '902052', '夹克', 'img/jacket.jpg', '大翻领配合拉链的夹克同样具有军装风貌,也可以叫哈雷机车夹克、摇滚夹克。领口是重点设计环节，暗扣或拉链装置随时可以加上保暖的毛领，还能根据需求竖起领子，或者配条围巾，防风又保暖。', '270', '10', '100');
INSERT INTO `goods` VALUES ('7', '902', '902034', '长裤', 'img/trousers.jpg', '黑色紧身裤和皮靴的搭配非常适宜，塑造摇滚街头风也很轻松。牛仔外套加围巾，洒脱加分，气场足足的', '200', '10', '70');
INSERT INTO `goods` VALUES ('8', '902', '902014', '长棉线帽', 'img/cap.jpg', '保暖帽做工精致，美观大方，戴上它肯定会给您增色不少哦！保证大风的寒冷天美美的发型不被吹乱外！', '40', '10', '26');
INSERT INTO `goods` VALUES ('9', '903', '903023', '圆珠笔', 'img/ballpen.jpg', '这款笔质感好，书写流畅，笔头都是金属的，材质性价比高。', '6', '10', '300');
INSERT INTO `goods` VALUES ('10', '903', '903058', 'b铅笔', 'img/pencil.jpg', '本款铅笔外观简洁，书写流畅，笔画细腻，不易折断，学习工作好助手。', '3', '10', '388');
INSERT INTO `goods` VALUES ('11', '903', '903044', 'b橡皮', 'img/eraser.jpg', '橡皮颜色正，质地柔软，软硬度适中，擦净能力强。', '4', '10', '200');
INSERT INTO `goods` VALUES ('12', '903', '903364', '尺子', 'img/ruler.jpg', '本绘图尺主要用于数学函数曲线和几何图形，解决了现实中手画图形慢、不标准从而影响解题思路的问题。', '2', '10', '100');
INSERT INTO `goods` VALUES ('13', '901', '901075', '樱桃', 'img/cherry.jpg', '甜樱桃味甜，皮薄，汁多。', '180', '10', '100');
INSERT INTO `goods` VALUES ('14', '901', '901032', '欧洲葡萄', 'img/grape.jpg', '果实甘美，醇厚。', '15', '10', '161');
INSERT INTO `goods` VALUES ('15', '902', '902008', '外套2', 'img/coat2.jpg', '大方时尚的外套。', '370', '10', '40');
INSERT INTO `goods` VALUES ('16', '902', '902012', '外套3', 'img/coat3.jpg', '青春流行的外套。', '460', '10', '18');
INSERT INTO `goods` VALUES ('17', '903', '903004', '曲别针', 'img/qubiezhen.jpg', '使用小型曲别针。', '3', '10', '28');
INSERT INTO `goods` VALUES ('18', '903', '903069', '钢笔', 'img/pen.jpg', '出墨流畅，颜色自然，耐用。', '28', '10', '90');
INSERT INTO `goods` VALUES ('19', '901', '903027', '东北山葡萄', 'img/grape4.jpg', '果皮厚，肉软，多汁。', '1', '10', '200');
INSERT INTO `goods` VALUES ('20', '901', '901095', '沙葡萄', 'img/grape5.jpg', '味酸甜，玫瑰香味浓郁。', '7', '10', '190');
INSERT INTO `goods` VALUES ('21', '901', '901009', '冰雪梨', 'img/pear2.jpg', '冰雪梨是梨的新品种', '10', '10', '10');
INSERT INTO `goods` VALUES ('26', '901', '9010026', 'a南光苹果', 'img/apple4.jpg', '南光苹果', '14', '10', '150');
INSERT INTO `goods` VALUES ('27', '901', '901008', 'a黄米香蕉', null, null, null, '10', null);
INSERT INTO `goods` VALUES ('28', '1', '1', '1', '1', '1', '1', null, '1');
...
CREATE TABLE `goods1` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `sectorid` int(10) NOT NULL,
  `prodno` varchar(10) DEFAULT NULL,
...
-- Records of goods1
-- ----------------------------
INSERT INTO `goods1` VALUES ('1', '901', '901023', '冰糖心苹果', 'img/apple.jpg', '冰糖心苹果果实个头中大，单重150-200克，大的可达500克以上。果面浓红，色泽艳丽，果形高桩，五棱突出，外观丰美，香甜可口。', '19', '0');
INSERT INTO `goods1` VALUES ('2', '901', '901058', '皇帝蕉', 'img/banana.jpg', '皇帝蕉果长约10厘米左右，无籽，皮薄、熟后皮金黄色，果肉橙黄、清甜芬芳、香甜可口，营养丰富，富含多种维生素。', '10', '0');
INSERT INTO `goods1` VALUES ('3', '901', '901044', '蜜桔', 'img/orange.jpg', '南丰蜜桔为我国古老柑桔的优良品种之一，是江西省的名贵特产，以果色金黄、皮薄肉嫩、食不存渣、风味浓甜、芳香扑鼻而闻名中外。', '8', '0');
INSERT INTO `goods1` VALUES ('4', '901', '901364', '大南果梨', 'img/pear3.jpg', '大南果梨, 果面光滑，果皮黄色，阳面有红晕，果皮薄，果心小，可食率高，肉质细腻，易溶于口。果品质量极优，是馈赠亲友的上佳礼品。', '10', '0');
INSERT INTO `goods1` VALUES ('5', '902', '902078', '外套', 'img/coat.jpg', '本款男士外套面料为精纺呢绒，坚牢耐穿， 长时间内不变形， 显得庄重，质地滑爽，外观高雅、挺括、触感丰满、风格经典、光泽自 然柔和等特点。', '320', '0');
INSERT INTO `goods1` VALUES ('6', '902', '902052', '夹克', 'img/jacket.jpg', '大翻领配合拉链的夹克同样具有军装风貌,也可以叫哈雷机车夹克、摇滚夹克。领口是重点设计环节，暗扣或拉链装置随时可以加上保暖的毛领，还能根据需求竖起领子，或者配条围巾，防风又保暖。', '270', '0');
INSERT INTO `goods1` VALUES ('7', '902', '902034', '长裤', 'img/trousers.jpg', '黑色紧身裤和皮靴的搭配非常适宜，塑造摇滚街头风也很轻松。牛仔外套加围巾，洒脱加分，气场足足的', '160', '0');
INSERT INTO `goods1` VALUES ('8', '902', '902014', '棉线帽', 'img/cap.jpg', '保暖帽做工精致，美观大方，戴上它肯定会给您增色不少哦！保证大风的寒冷天美美的发型不被吹乱外！', '40', '0');
INSERT INTO `goods1` VALUES ('9', '903', '903023', '圆珠笔', 'img/ballpen.jpg', '这款笔质感好，书写流畅，笔头都是金属的，材质性价比高。', '6', '0');
INSERT INTO `goods1` VALUES ('10', '903', '903058', '铅笔', 'img/pencil.jpg', '本款铅笔外观简洁，书写流畅，笔画细腻，不易折断，学习工作好助手。', '3', null);
INSERT INTO `goods1` VALUES ('11', '903', '903044', '橡皮', 'img/eraser.jpg', '橡皮颜色正，质地柔软，软硬度适中，擦净能力强。', '4', null);
INSERT INTO `goods1` VALUES ('12', '903', '903364', '尺子', 'img/ruler.jpg', '本绘图尺主要用于数学函数曲线和几何图形，解决了现实中手画图形慢、不标准从而影响解题思路的问题。', '2', null);
INSERT INTO `goods1` VALUES ('13', '901', '901075', '樱桃', 'img/cherry.jpg', null, '18', '0');
INSERT INTO `goods1` VALUES ('14', '901', '901032', '葡萄', 'img/grape.jpg', null, '15', '0');
INSERT INTO `goods1` VALUES ('15', '902', '902008', '外套2', 'img/coat2.jpg', null, '370', '0');
INSERT INTO `goods1` VALUES ('16', '902', '902012', '外套3', 'img/coat3.jpg', null, '460', '0');
INSERT INTO `goods1` VALUES ('17', '903', '903004', '曲别针', 'img/qubiezhen.jpg', null, '3', '0');
INSERT INTO `goods1` VALUES ('18', '903', '903069', '钢笔', 'img/pen.jpg', null, '28', '0');
INSERT INTO `goods1` VALUES ('19', '903', null, 'aaa', null, null, null, null);
INSERT INTO `goods1` VALUES ('20', '904', '12345', 'bbb', null, null, null, null);

-- ----------------------------
-- Table structure for `payedgoodstable`
-- ----------------------------
DROP TABLE IF EXISTS `payedgoodstable`;
CREATE TABLE `payedgoodstable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) NOT NULL,
  `sectorid` int(11) NOT NULL,
  `goodsid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of payedgoodstable
-- ----------------------------
INSERT INTO `payedgoodstable` VALUES ('4', '1', '901', '901023', '冰糖心苹果', '19', '16', '2014-1');
INSERT INTO `payedgoodstable` VALUES ('5', '1', '901', '901058', '皇帝蕉', '10', '14', '2014-10-28 07:53:11');
INSERT INTO `payedgoodstable` VALUES ('6', '1', '901', '901023', '冰糖心苹果', '19', '44', '2014-10-28 08:01:38');
INSERT INTO `payedgoodstable` VALUES ('7', '1', '902', '902052', '夹克', '270', '2', '2014-10-28 08:02:46');
INSERT INTO `payedgoodstable` VALUES ('8', '1', '903', '903058', '铅笔', '3', '11', '2014-10-28 08:02:48');
INSERT INTO `payedgoodstable` VALUES ('9', '1', '903', '903044', '橡皮', '4', '3', '2014-10-28 08:02:49');
INSERT INTO `payedgoodstable` VALUES ('10', '1', '901', '901044', '蜜桔', '8', '10', '2014-10-28 08:04:14');
INSERT INTO `payedgoodstable` VALUES ('11', '1', '902', '902052', '夹克', '270', '4', '2014-10-28 08:05:29');
INSERT INTO `payedgoodstable` VALUES ('12', '1', '903', '903023', '圆珠笔', '6', '5', '2014-10-28 08:05:30');
INSERT INTO `payedgoodstable` VALUES ('13', '1', '903', '903044', '橡皮', '4', '10', '2014-10-28 08:05:31');
INSERT INTO `payedgoodstable` VALUES ('14', '1', '903', '903058', '铅笔', '3', '10', '2014-10-28 08:06:19');
INSERT INTO `payedgoodstable` VALUES ('15', '1', '901', '901058', '皇帝蕉', '10', '20', '2014-10-28 08:46:19');
INSERT INTO `payedgoodstable` VALUES ('16', '1', '901', '901044', '蜜桔', '8', '1', '2014-10-28 08:46:19');
INSERT INTO `payedgoodstable` VALUES ('17', '1', '902', '902034', '长裤', '200', '3', '2014-10-28 08:46:19');
INSERT INTO `payedgoodstable` VALUES ('18', '1', '901', '901009', '冰雪梨', '10', '1', '2014-10-28 08:46:19');
INSERT INTO `payedgoodstable` VALUES ('19', '1', '902', '902052', '夹克', '270', '6', '2014-10-28 08:47:58');
INSERT INTO `payedgoodstable` VALUES ('20', '1', '903', '903044', '橡皮', '4', '1', '2014-10-28 08:48:04');
INSERT INTO `payedgoodstable` VALUES ('21', '1', '901', '901058', '皇帝蕉', '10', '1', '2014-10-28 08:52:44');
INSERT INTO `payedgoodstable` VALUES ('22', '1', '901', '901058', '皇帝蕉', '10', '2', '2014-10-28 08:53:53');
INSERT INTO `payedgoodstable` VALUES ('23', '1', '902', '902078', '外套', '320', '2', '2014-10-28 08:53:56');
INSERT INTO `payedgoodstable` VALUES ('24', '27', '902', '902078', '外套', '320', '2', '2014-10-28 08:54:44');
INSERT INTO `payedgoodstable` VALUES ('25', '27', '901', '901058', '皇帝蕉', '10', '20', '2014-10-28 08:54:45');
INSERT INTO `payedgoodstable` VALUES ('26', '27', '901', '901058', '皇帝蕉', '10', '20', '2014-10-28 08:54:46');
INSERT INTO `payedgoodstable` VALUES ('27', '27', '901', '901023', '冰糖心苹果', '19', '20', '2014-10-28 08:54:47');
INSERT INTO `payedgoodstable` VALUES ('28', '27', '903', '903058', '铅笔', '3', '12', '2014-10-28 08:54:48');
INSERT INTO `payedgoodstable` VALUES ('29', '28', '901', '901364', '大南果梨', '10', '10', '2014-10-28 09:28:49');
INSERT INTO `payedgoodstable` VALUES ('30', '28', '901', '901095', '沙葡萄', '7', '10', '2014-10-28 09:28:51');
INSERT INTO `payedgoodstable` VALUES ('31', '28', '901', '901009', '冰雪梨', '10', '10', '2014-10-28 09:28:52');
INSERT INTO `payedgoodstable` VALUES ('32', '28', '903', '903069', '钢笔', '28', '10', '2014-10-28 09:32:08');
INSERT INTO `payedgoodstable` VALUES ('33', '28', '901', '901058', '皇帝蕉', '10', '2', '2014-10-28 09:33:37');
INSERT INTO `payedgoodstable` VALUES ('34', '29', '902', '902052', '夹克', '270', '2', '2014-10-28 09:36:05');
INSERT INTO `payedgoodstable` VALUES ('35', '29', '902', '902014', '棉线帽', '40', '4', '2014-10-28 09:36:09');
INSERT INTO `payedgoodstable` VALUES ('36', '30', '903', '903058', '铅笔', '3', '100', '2014-10-28 09:39:19');
INSERT INTO `payedgoodstable` VALUES ('37', '30', '901', '901032', '欧洲葡萄', '15', '20', '2014-10-28 09:39:20');
INSERT INTO `payedgoodstable` VALUES ('38', '30', '903', '903004', '曲别针', '3', '12', '2014-10-28 09:39:20');
INSERT INTO `payedgoodstable` VALUES ('39', '47', '901', '901058', '皇帝蕉', '10', '149', '2014-10-28 09:53:46');
INSERT INTO `payedgoodstable` VALUES ('40', '47', '902', '902052', '夹克', '270', '38', '2014-10-28 09:53:46');
INSERT INTO `payedgoodstable` VALUES ('41', '1', '901', '901032', '欧洲葡萄', '15', '19', '2014-11-03 07:54:37');
INSERT INTO `payedgoodstable` VALUES ('42', '1', '902', '902012', '外套3', '460', '2', '2014-11-03 07:54:37');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'cc', '张明', '123', '02087965423', '广州市白云区白云新街103号', '501515', 'zmshopping@qq.com');
INSERT INTO `user` VALUES ('27', 'abc1', '许画', '123', '01086532145', '北京市海淀区广安门街54号', '100278', 'xuli@163.com');
INSERT INTO `user` VALUES ('28', 'abc2', '刘未', '123', '01386363451', '杭州市权炎区果子巷62号', '340576', 'liuwei@126.com');
INSERT INTO `user` VALUES ('29', 'abc3', '李体', '123', '02083321523', '广州市天河区宏成路93号', '540369', 'liti@xina.com');
INSERT INTO `user` VALUES ('30', 'abc4', '王但', '123', '0216345215', '上海市徐汇区南京路8685号', '6320147', 'wandan@qq.com');
INSERT INTO `user` VALUES ('47', 'abc5', '111', '111', '1234', '1234', '1234', '1234');
INSERT INTO `user` VALUES ('48', '111', '111', '111', '111', '111', '111', '111');
...
-- ----------------------------
INSERT INTO `yydk_user` VALUES ('1', 'admin', 'zou', 'admin', 'aaa@163.com', '13812345678', '4866815', '10000');
INSERT INTO `yydk_user` VALUES ('2', 'abc', null, '1234567', null, null, null, null);
INSERT INTO `yydk_user` VALUES ('3', 'aaaaaa', null, '1234567', null, null, null, null);
...
INSERT INTO `yydk_user` VALUES ('11', 'dddfsdf', null, 'zoufeng', null, null, null, null);
INSERT INTO `yydk_user` VALUES ('12', 'zoufeng', null, 'zoufeng', null, null, null, null);
