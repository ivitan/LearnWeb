...
<body>
   ...
   int i=login.check();
 //  System.out.print(i);
 if(request.getParameter("checkCode").equalsIgnoreCase((String)session.getAttribute("randCheckCode"))) {
   if(i==1){
	  session.setAttribute("flag", i);
    %>
	<div align="center">
		<h3>
			欢迎<font color="#ff0000"><jsp:getProperty name="login"
					property="username" /></font>进入人事管理系统
		</h3>
		<table width="400" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="25%" height="30" align="center"><a href="index.jsp">档案管理</a>
				</td>
				<td width="25%" align="center"><a href="#">培训管理</a></td>
				<td width="25%" align="center"><a href="#">奖惩管理</a></td>
				<td width="25%" align="center"><a
					href="javascript:if(window.confirm('是否确认删除？')){window.location.href='loginout.jsp';}">退出系统</a>
				</td>
			</tr>
		</table>
	</div>
