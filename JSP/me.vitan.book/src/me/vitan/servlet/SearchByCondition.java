...
public class SearchByCondition extends HttpServlet{
   ...
   public void doPost(HttpServletRequest request,HttpServletResponse response) 
      ...
      String condition="";
      if(radioMess.equals("ID")) {
          condition = 
         "SELECT * FROM book where ID like '%"+searchMess+"%'";
      }
      else if(radioMess.equals("Name")) {
          condition = 
         "SELECT * FROM book where Name LIKE '%"+searchMess+"%'"; 
      }
          ...
          condition =  "SELECT * FROM book where "+
   ...
   public void fail(HttpServletRequest request,HttpServletResponse response,
        ...
        try {
         ...
         out.println("返回：");
         out.println("<a href =SearchBook.jsp>查询书籍</a>");
