    ...
    <div class="content">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:ImageField DataImageUrlField="产品图片" DataImageUrlFormatString="img\{0}" 
                    HeaderText="产品图片">
                </asp:ImageField>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="产品编号" 
                    DataNavigateUrlFormatString="xq.aspx?bianhao={0}" DataTextField="产品名称" 
                    HeaderText="查看详情" />
            </Columns>
        </asp:GridView>
