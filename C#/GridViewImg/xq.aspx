<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xq.aspx.cs" Inherits="xq" %>
...
<body>
    ...
    <div>
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [商品明细] WHERE ([产品编号] = ?)">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="1" Name="产品编号" 
                    QueryStringField="bianhao" Type="String" />
            </SelectParameters>
