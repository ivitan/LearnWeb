...
<body>
    ...
    <div>
        <asp:Panel ID="Panel2" runat="server">
            请选择学生的籍贯：<asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="AccessDataSource1"
                DataTextField="学生籍贯" DataValueField="学生籍贯">
            </asp:DropDownList>
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/tianpingdian.mdb"
                SelectCommand="SELECT  distinct [学生籍贯] FROM [成绩实例]"></asp:AccessDataSource>
