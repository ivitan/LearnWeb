<%@ Page Title="" Language="C#" Debug="true" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="showclass.aspx.cs" Inherits="showclass" %>
                        ...
                        <ItemTemplate>
                            <table class="first">
                                ...
                                <tr>
                                    <td>
                                        所选课程：
                                        <asp:Label ID="lblstuage" runat="server" Text='<%# Eval("Cno") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        成绩：<asp:Label ID="lblstuHobby" runat="server" Text='<%# Eval("Grade") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
