...
public partial class SQL_SERVER_classdel : System.Web.UI.Page
{
    ...
    public void GridViewBind()
    {
        ...
        GridView1.DataKeyNames = new string[] { "课程号", "课程名" };
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        //定义SQL语句
        string SqlStr = " delete from c where 课程号='" + sno_str + "'" + " and 课程名='" + cno_str + "'";
        SqlConnection myConn = GetCon();
