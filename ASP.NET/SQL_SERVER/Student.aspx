...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="charu">
        <div id="insertquyu">
            ...
            <br />
            请输入姓名：<asp:TextBox ID="TextBox2" runat="server" placeholder="填入姓名"></asp:TextBox>
            <br />
            ...
            <br />
            请选择所在系：<asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2"
