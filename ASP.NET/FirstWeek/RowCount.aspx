<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeFile="RowCount.aspx.cs"
    Inherits="RowCount" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="学号"
            DataSourceID="AccessDataSource1" OnRowDataBound="rowDTbound">
            <Columns>
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/tianpingdian.mdb"
            SelectCommand="SELECT * FROM [成绩实例]"></asp:AccessDataSource>
    </div>
    </form>
</body>
</html>
