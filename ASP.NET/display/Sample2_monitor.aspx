<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sample2_monitor.aspx.cs"
    Inherits="Sample2_monitor" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title></title>
    <link href="S2_css.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div>
        ...
        <asp:AccessDataSource ID="ADS_LV" runat="server" DataFile="~/mdb/EV.mdb" 
...
WHERE MO_ENABLE=TRUE AND MO_DELETE=FALSE ORDER BY MO_ORDER DESC"
            UpdateCommand="UPDATE [TB_MONITOR] SET [mo_seid] = ?, [mo_siid] = ?, [mo_imgid] = ?, [mo_name] = ?, [mo_enable] = ?, [mo_order] = ?, [mo_phdmi] = ?, [mo_pvga] = ?, [mo_pdvi] = ? WHERE [mo_id] = ?">
            <DeleteParameters>
