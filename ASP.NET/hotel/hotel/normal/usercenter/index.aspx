<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="normal_usercenter_index" %>
...
<table class="table table-bordered table-hover definewidth m10" >
  ...
  <tr>
    ...
    <td>
        <asp:Image ID="avatarImg" runat="server" Height="70px" Width="70px" /><br>
    </td>
  </tr>
  <tr>
