<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="manager_type_edit" %>
<!DOCTYPE html>
<html>
<head>
    <title></title>
...
<table class="table table-bordered table-hover definewidth m10">
     ...
     <tr>
        <td width="10%" class="tableleft">类型号</td>
        <td>
            <asp:TextBox ID="tid" runat="server" ReadOnly="True"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">类型名</td>
        <td>
            <asp:TextBox ID="typename" runat="server" AutoPostBack="True" ></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="price" runat="server" AutoPostBack="True" ></asp:TextBox>￥
